...
/*		ItemStack divider = new ItemStack(Material.STAINED_GLASS_PANE, 1, (byte) 15);
		...
		ItemStack totalMoney = new ItemStack(Material.BUCKET);
		
		divider = setName(divider, ChatColor.BLACK + "Divider");
		acceptButton = setName(acceptButton, ChatColor.GREEN + "Accept");
		declineButton = setName(declineButton, ChatColor.RED + "Decline");
		oneDollar = setName(oneDollar, ChatColor.WHITE + "Add $1");
		tenDollar = setName(tenDollar, ChatColor.WHITE + "Add $10");
		hundredDollar = setName(hundredDollar, ChatColor.WHITE + "Add $100");
		totalMoney = setName(totalMoney, ChatColor.WHITE + "Total: " + "WORK IN PROGRESS");
